...
- Use Case #6: main success scenario and both extensions pass. `OrderController` correctly returns HTTP 412 for a fulfill request on a nonexistent order (lines 89-92) and HTTP 410 for one already fulfilled (lines 96-98), preventing double-fulfillment.
